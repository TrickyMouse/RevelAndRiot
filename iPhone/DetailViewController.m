...
- (void)viewDidLoad {
	...
	//NSLog(@"%@",content);
	NSString *styledString = [[NSString alloc] initWithFormat:@"<style>img {max-width:310px!important;iframe {max-width:310px!important;}</style><h3>%@</h3>%@", titleString, contentString];
