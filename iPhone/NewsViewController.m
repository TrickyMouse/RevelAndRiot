...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	revelViewCell *cell = (revelViewCell *)[tableView dequeueReusableCellWithIdentifier:cellID];
	...
	if (cell == nil) {
		...
		NSArray *nibObjects = [[NSBundle mainBundle] loadNibNamed:@"revelViewCell" owner:nil options:nil];
		
		for (id currentObject in nibObjects) {
			if([currentObject isKindOfClass:[revelViewCell class]])
			{
				cell = (revelViewCell *)currentObject;
			}
		}
	}
...
- (IBAction)menuButtonPressed:(id)sender {
	...
	if (self.mainViewController == nil) {
		MainViewController *newsView = [[MainViewController alloc] initWithNibName:@"MainViewController" bundle:[NSBundle mainBundle]];
		self.mainViewController = newsView;
		[newsView release];
		NSLog(@"newsView retainCount:%d",[newsView retainCount]);
	}
...
- (IBAction) revelButtonPressed:(id)sender {
	...
	tableBackground.image = [UIImage imageNamed:@"tablebackground.jpg"];
